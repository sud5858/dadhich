...
<div class="dropdown">
 <button class="fa fa-user btn btn-danger" aria-hidden="true" type="button" data-toggle="dropdown"><i ></i><span class="caret"></button>
                ...
                <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                    <ul class="nav navbar-nav nav_1">
                        ...
                        <li class="dropdown mega-dropdown active">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Fruits & Vegitables<span class="caret"></span></a>               
                            <div class="dropdown-menu mega-dropdown-menu w3ls_vegetables_menu">
                                <div class="w3ls_vegetables">
                                    <ul>    
                                        <li><a href="vegetables.html">Vegitable</li>
                        ...
                        <li class="dropdown">
                            <a href="{{url('drinks-categories')}}" >Drinks Category<span class="caret"></span></a>
                            <div class="dropdown-menu mega-dropdown-menu w3ls_vegetables_menu">
                                <div class="w3ls_vegetables">
                                    <ul>
